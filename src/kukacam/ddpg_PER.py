...
class DDPG_PER_Agent:
    def __init__(self, state_size, action_size,
        ...
        self.replay_buffer = Memory(self.memory_capacity, self.batch_size,
    ...
    def experience_replay(self):
        ...
        state_batch, action_batch, reward_batch, \
                next_state_batch, \
                 sampled_idxs, is_weights = self.replay_buffer.sample()
        ...
        for i in range(len(sampled_idxs)):
            self.replay_buffer.update(sampled_idxs[i], is_weights[i])

        with open('./root_value.txt', 'a+') as file:
            file.write('{}\t{:0.3f}\n'.format(self.replay_buffer.available_samples,
                                            self.replay_buffer.sum_tree.root_node.value))
    ...
    def save_model(self, path, actor_filename,
        ...
        self.replay_buffer.save_data(buffer_file)
    ...
    def load_model(self, path, actor_filename,
        ...
        self.replay_buffer.load_data(buffer_file)
