...
class SACActor:
    ...
    def policy(self, state):
        ...
        if tf.experimental.numpy.isscalar(action_):
...
class SACAgent:
    def __init__(self, env, state_size, action_size, action_upper_bound,
                seasons=50, training_batch=1024, epochs=20,
                buffer_capacity=20000, batch_size=128, 
                lr_a=0.0003, lr_c=0.0003, gamma=0.99, tau=0.995, alpha=0.2,
                use_attention=None, 
