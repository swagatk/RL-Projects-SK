''' This is another implementation available on internet that appears
to perform better than my own implementation
'''
import os
import random
import gym
...
class DQNAgent:
    ...
    def PlotModel(self, score, episode):
        ...
        pylab.ylabel('Average of last 100 Scores', fontsize=18)
        ...
        for e in range(self.EPISODES):
            ...
            while not done:
                ...
                if done:
                    ...
                    with open('./data2/cp_d3qn_PER_v3.txt','a+') as file2:
                        file2.write('{}\t {} \t {:0.2f} \t {} \n'\
                                    .format(e, i, explore_probability, average))
